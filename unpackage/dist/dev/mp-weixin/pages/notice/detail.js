...
const api_notice_index = require("../../api/notice/index.js");
if (!Array) {
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getNoticeDetail = async (id) => {
      let res = await api_notice_index.getNewsDetail(id);
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-0f737f11"], ["__file", "E:/桌面/uni-app/练习/wall-uni/pages/notice/detail.vue"]]);
