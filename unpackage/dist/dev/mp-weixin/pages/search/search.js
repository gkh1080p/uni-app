...
const api_search_index = require("../../api/search/index.js");
if (!Array) {
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const onSearch = () => {
      ...
      historySearch.value = Array.from(/* @__PURE__ */ new Set([queryParams.value.keyword, ...historySearch.value])).slice(0, 10);
    ...
    const searchData = async () => {
      try {
        let res = await api_search_index.getSearchWall(queryParams.value.keyword, queryParams.value.pageNum, queryParams.value.pageSize);
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-c10c040c"], ["__file", "E:/桌面/uni-app/练习/wall-uni/pages/search/search.vue"]]);
