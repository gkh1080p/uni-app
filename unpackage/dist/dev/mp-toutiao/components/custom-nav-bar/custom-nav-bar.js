  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return {
        ...
        c: common_vendor.unref(utils_system.titleBarHeight)() + "px",
        d: common_vendor.unref(utils_system.getLeftIcon)() + "px",
        e: common_vendor.unref(utils_system.statusBarHeight)() + common_vendor.unref(utils_system.titleBarHeight)() + "px"
      };
    };
  }
};
